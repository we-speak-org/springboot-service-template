...
public class ExampleController {
    ...
    @PreAuthorize("hasRole('USER')")
    @Operation(summary = "Get example by code", description = "Retrieve a specific example by its unique code")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Successfully retrieved"),
            @ApiResponse(responseCode = "404", description = "Example not found")
    })
    ...
    @Operation(summary = "Delete example", description = "Delete an example by ID (requires ADMIN role)")
    @ApiResponses({
